...
public final class ChatCapturingFakePlayer extends FakePlayer {
    ...
    private void detachAdvancements() {
        ...
        playerAdvancements.dispose();
        PlayerList playerList = FMLCommonHandler.instance()
            .getMinecraftServerInstance()
            .getPlayerList();
        Map<UUID, PlayerAdvancements> advancements = ObfuscationReflectionHelper
            .getPrivateValue(PlayerList.class, playerList, "field_192055_p");
        advancements.remove(getUniqueID(), playerAdvancements);
    }
}
