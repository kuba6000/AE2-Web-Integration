...
<section id="terminalgrid">
    ...
    <section style='display: none;'>
        <section style='display: flex; flex-direction: row; flex-wrap: wrap;'>
            ...
            <span class='note' style="flex: 0 0 100%; margin-top: 10px;">To be able to select a grid, there must be a wireless access point available, and you have to be owner of it (you have to be the one who placed it).</span>
        </section>
    </section>
</section>
